...
| Denomination | Preview | Usage in VS Code |
| :----------: | :-----: | ---------------- |
| `coldark00` | ![#f0f4f8][#f0f4f8] | Lightest surfaces such as active tabs, widgets, and elevated panels |
| `coldark01` | ![#e3eaf2][#e3eaf2] | Bright backgrounds in Coldark Cold and the default foreground in Coldark Dark |
| `coldark02` | ![#d0dae7][#d0dae7] | Soft foregrounds and secondary surfaces |
| `coldark03` | ![#8da1b9][#8da1b9] | Selection backgrounds, borders, and muted emphasis |
| `coldark04` | ![#3c526d][#3c526d] | Comments, placeholders, and subdued text |
| `coldark05` | ![#213043][#213043] | Strong surfaces like widgets and line highlights |
| `coldark06` | ![#111b27][#111b27] | Main dark foreground in Coldark Cold and main background in Coldark Dark |
| `coldark07` | ![#0b121b][#0b121b] | Deep structural background for activity bars, gutters, and borders |

### Accent colors

`coldark08` to `coldark15` are fixed accent slots by hue, with one value for Coldark Cold and another for Coldark Dark.

| Denomination | Coldark Cold | Coldark Dark | Usage in VS Code |
| :----------: | :----------: | :----------: | ---------------- |
| `coldark08` | ![#c22f2e][#c22f2e] | ![#cd6660][#cd6660] | Red for errors, deletions, invalid states, and deprecated items |
| `coldark09` | ![#a04900][#a04900] | ![#e9ae7e][#e9ae7e] | Orange for warnings, debugging status bar, keywords, storage, and CSS pseudo-elements |
| `coldark10` | ![#755f00][#755f00] | ![#e6d37a][#e6d37a] | Yellow for modified states, hints, integers, booleans, language constants, attribute names, shell case patterns, and link URLs |
| `coldark11` | ![#116b00][#116b00] | ![#91d076][#91d076] | Green for additions, strings, CSS colors, CSS font names, and link text |
| `coldark12` | ![#006d6d][#006d6d] | ![#66cccc][#66cccc] | Cyan for merge incoming content, parameters, tags, CSS variables, inline raw markup, and embedded section punctuation |
| `coldark13` | ![#005a8e][#005a8e] | ![#6cb8e6][#6cb8e6] | Blue for badges, buttons, find match, info states, merge current content, selection outside editor, classes, variables, and headings |
| `coldark14` | ![#7c00aa][#7c00aa] | ![#c699e3][#c699e3] | Purple for unverified states, functions, and CSS classes or IDs |
| `coldark15` | ![#af00af][#af00af] | ![#f4adf4][#f4adf4] | Magenta for untracked states, token expression values, regex, escapes, character constants, storage modifiers, instances, list punctuation, and CSS values |
