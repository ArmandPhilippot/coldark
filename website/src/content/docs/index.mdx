...
<CardGrid>
  <Card title="VS Code" href="/variants/coldark-vscode/" icon="vscode">
    The reference implementation of the Coldark palette for Visual Studio Code.
  </Card>
  <Card title="Prism" href="/variants/coldark-prism/" icon="document">
    A web-friendly syntax highlighting theme for Prism.js.
  </Card>
  <Card title="Firefox" href="/variants/coldark-firefox/" icon="firefox">
    A browser theme that follows the system preference and supports manual
    switching.
  </Card>
  <Card title="bat" href="/variants/coldark-bat/" icon="terminal-window">
    Terminal syntax highlighting for bat with cold and dark variants.
  </Card>
  <Card title="dircolors" href="/variants/coldark-dircolors/" icon="folder">
    File-type coloring for shells and tools that use `LS_COLORS`.
  </Card>
  <Card
    title="GTKSourceView"
    href="/variants/coldark-gtksourceview/"
    icon="pencil"
  >
  ...
  <Card
    ...
    href="/variants/coldark-xfce4-terminal/"
