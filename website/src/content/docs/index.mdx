...
<CardGrid>
  ...
  <Card title="Prism" href="/coldark/variants/coldark-prism/" icon="seti:default">
  ...
  <Card title="bat" href="/coldark/variants/coldark-bat/" icon="seti:shell">
    Terminal syntax highlighting for bat with cold and dark variants.
  </Card>
  <Card title="dircolors" href="/coldark/variants/coldark-dircolors/" icon="seti:folder">
